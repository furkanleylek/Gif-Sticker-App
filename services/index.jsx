...
export async function fetchGifTrends() {
    try {
        const res = await fetchData("/v1/gifs/trending", "&limit=25", "&rating=g")
        return res.data
    } catch (error) {
...
export async function fetchStickerTrends() {
    try {
        const res = await fetchData("/v1/stickers/trending", "&limit=25", "&rating=g")
        return res.data
    } catch (error) {
        throw new Error("Error happened while fetching trends", error);
    }
...
//     try {
//         const res = await fetchData('v1/stickers/packs/3138/children')
//         console.log(res)
//         return res.data
//     }
//     catch (error) {
//         throw new Error("Error happened while fetching stickers", error);
//     }
// }